...
test_LDA_one is a list of predictions for variable class, posteriors for each class of each case, and the linear discriminant.
...
Both models perform equally well and predicted the class correctly for all cases.

When fitting LDA and QDA to dataset when two class have different corellation structure
```{r}
